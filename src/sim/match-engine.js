...
import { decideOnBall, offBallIntent, defendIntent, gkIntent, attachBias } from './ai.js?build=d9e11ec4';
...
export class MatchEngine {
  ...
  _executeKick(p, kick) {
    ...
    if (kick.type === 'shot') {
      ...
      this._shotCd[p.team] = this.worldCup ? 4.2 : 1.8;
