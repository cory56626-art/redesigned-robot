...
import { TILE, normalizeDifficulty } from '../config.js?v=first-world-no-ore-boss-1';
...
import { aabb, angleTo, randRange, clamp } from '../utils.js?v=first-world-no-ore-boss-1';
