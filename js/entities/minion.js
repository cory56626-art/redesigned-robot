...
import { minionDef } from '../data/minions.js?v=worm-pathing-1';
import { initAidanState, updateAidanState } from './aidan.js?v=worm-pathing-1';
import { dist2, aabb, angleTo } from '../utils.js?v=worm-pathing-1';
