...
class Game {
  ...
  init() {
    ...
    this.ui.menuScene = new MenuScene(this);
    this.ui.menuScene.start();
  ...
  _loop(ts) {
    ...
    try {
      ...
      if (this.state !== 'playing') {
        ...
        // Nothing draws to the canvas outside a loaded world, so the menu owns
        // it: a small parallax diorama plus the animated title.
        if (this.ui.menuScene) this.ui.menuScene.update(dt);
      }
  ...
  _enterPlaying() {
    this.state = 'playing';
    this.paused = false;
    if (this.ui.menuScene) this.ui.menuScene.stop();
    this.ui.menus.hideMainMenu();
  ...
  quitToMenu() {
    ...
    this.state = 'menu';
    this.paused = false;
    if (this.ui.menuScene) this.ui.menuScene.start();
    this.ui.hud.hide();
    this.ui.menus.hidePause();
