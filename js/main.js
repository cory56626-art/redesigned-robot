...
import { Renderer } from './engine/renderer.js?v=realms-4';
...
import { Enemy } from './entities/enemy.js?v=realms-4';
import { Boss } from './entities/boss.js?v=realms-4';
import { Minion } from './entities/minion.js?v=realms-2';
import { Npc } from './entities/npc.js?v=realms-4';
import { Projectile } from './entities/projectile.js?v=realms-4';
