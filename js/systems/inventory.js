...
import { HOTBAR_SIZE, INV_ROWS, INV_COLS, ACCESSORY_SLOTS } from '../config.js?v=realms-difficulty-22';
import { ITEMS, item as getItem } from '../data/items.js?v=realms-difficulty-22';
