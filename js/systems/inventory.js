...
import { HOTBAR_SIZE, INV_ROWS, INV_COLS, ACCESSORY_SLOTS } from '../config.js?v=snowy-taiga-underground-1';
import { ITEMS, item as getItem } from '../data/items.js?v=snowy-taiga-underground-1';
