...
import { HOTBAR_SIZE, INV_ROWS, INV_COLS, ACCESSORY_SLOTS } from '../config.js?v=worm-surface-1';
import { ITEMS, item as getItem, isItemEnabled } from '../data/items.js?v=worm-surface-1';
