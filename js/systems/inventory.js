...
import { HOTBAR_SIZE, INV_ROWS, INV_COLS, ACCESSORY_SLOTS } from '../config.js?v=title-screen-1';
import { ITEMS, item as getItem, isItemEnabled } from '../data/items.js?v=title-screen-1';
