...
import { TILE, REACH, HEAL_COOLDOWN, MANA_POTION_COOLDOWN, POTION_BUFF_COOLDOWN, CAST_REGEN_DELAY, LIQUID_MAX } from '../config.js?v=worm-breach-1';
import { T, tileDef, isTree, isLeaf } from '../world/tiles.js?v=worm-breach-1';
import { trunkMask, leafMask, spriteVariant } from '../art/sprites.js?v=worm-breach-1';
import { SH, nextShape } from '../world/shapes.js?v=worm-breach-1';
import { W } from '../world/walls.js?v=worm-breach-1';
...
import { angleTo, aabb, clamp } from '../utils.js?v=worm-breach-1';
