...
import { TILE, UNDERGROUND_Y, MAX_ENEMIES, normalizeDifficulty, ENEMY_DIFFICULTY_TUNING } from '../config.js?v=worm-surface-2';
import { ENEMIES } from '../data/enemies.js?v=worm-surface-2';
import { FAUNA } from '../data/fauna.js?v=worm-surface-2';
import { aabb, dist2 } from '../utils.js?v=worm-surface-2';
