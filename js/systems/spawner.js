...
import { TILE, UNDERGROUND_Y, MAX_ENEMIES, normalizeDifficulty, ENEMY_DIFFICULTY_TUNING } from '../config.js?v=the-worm-1';
import { ENEMIES } from '../data/enemies.js?v=the-worm-1';
import { FAUNA } from '../data/fauna.js?v=the-worm-1';
import { aabb, dist2 } from '../utils.js?v=the-worm-1';
