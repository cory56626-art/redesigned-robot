...
import { TILE, UNDERGROUND_Y, MAX_ENEMIES, normalizeDifficulty, ENEMY_DIFFICULTY_TUNING } from '../config.js?v=prehardmode-ores-1';
import { ENEMIES } from '../data/enemies.js?v=prehardmode-ores-1';
import { FAUNA } from '../data/fauna.js?v=prehardmode-ores-1';
import { aabb, dist2 } from '../utils.js?v=prehardmode-ores-1';
