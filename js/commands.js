...
import { ITEMS, DEMO_GIVE_ALL, allItemIds, isItemEnabled } from './data/items.js?v=vespera-surface-5';
import { ENEMY_KEYS, ENEMIES } from './data/enemies.js?v=vespera-surface-5';
import { BOSS_KEYS, BOSSES } from './data/bosses.js?v=vespera-surface-5';
import { TRACKS } from './engine/music.js?v=vespera-surface-5';
import { FAUNA } from './data/fauna.js?v=vespera-surface-5';
import { ACHIEVEMENTS } from './systems/achievements.js?v=vespera-surface-5';
import { TILE, LIQUID_MAX } from './config.js?v=vespera-surface-5';
