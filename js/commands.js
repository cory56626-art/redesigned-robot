...
import { ITEMS, DEMO_GIVE_ALL } from './data/items.js?v=snowy-taiga-npc-2';
import { ENEMY_KEYS, ENEMIES } from './data/enemies.js?v=snowy-taiga-npc-2';
import { BOSS_KEYS, BOSSES } from './data/bosses.js?v=snowy-taiga-npc-2';
import { TRACKS } from './engine/music.js?v=snowy-taiga-npc-2';
import { FAUNA } from './data/fauna.js?v=snowy-taiga-npc-2';
import { ACHIEVEMENTS } from './systems/achievements.js?v=snowy-taiga-npc-2';
import { TILE, LIQUID_MAX } from './config.js?v=snowy-taiga-npc-2';
