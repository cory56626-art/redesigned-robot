...
import { TILE, UNDERGROUND_Y, CAVERN_Y } from '../config.js?v=worm-surface-4';
import { T, isSolid, tileDef } from '../world/tiles.js?v=worm-surface-4';
import { hasWall } from '../world/walls.js?v=worm-surface-4';
