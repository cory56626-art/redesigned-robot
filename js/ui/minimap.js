...
import { TILE, UNDERGROUND_Y, CAVERN_Y } from '../config.js?v=vespera-surface-5';
import { T, isSolid, tileDef } from '../world/tiles.js?v=vespera-surface-5';
import { hasWall } from '../world/walls.js?v=vespera-surface-5';
