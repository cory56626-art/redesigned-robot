...
import { TILE, UNDERGROUND_Y, CAVERN_Y } from '../config.js?v=prehardmode-mech-1';
import { T, isSolid, tileDef } from '../world/tiles.js?v=prehardmode-mech-1';
import { hasWall } from '../world/walls.js?v=prehardmode-mech-1';
