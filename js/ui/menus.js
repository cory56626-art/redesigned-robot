...
import { HOTBAR_SIZE, HEAL_COOLDOWN, MANA_POTION_COOLDOWN, difficultyForIndex, difficultyInfo } from '../config.js?v=vespera-surface-5';
import { INV_SIZE, SET_BONUS_DESC, SET_LABEL } from '../systems/inventory.js?v=vespera-surface-5';
import { Sprites } from '../art/sprites.js?v=vespera-surface-5';
import { item as getItem } from '../data/items.js?v=vespera-surface-5';
import { availableRecipes } from '../systems/crafting.js?v=vespera-surface-5';
import { claudeNotesHTML } from './claude-notes.js?v=vespera-surface-5';
import { LOOK_PALETTES, HAIR_STYLES, defaultAppearance } from '../save.js?v=vespera-surface-5';
import { ACHIEVEMENT_BY_ID } from '../systems/achievements.js?v=vespera-surface-5';
import { drawCharacterPreview } from '../art/charpreview.js?v=vespera-surface-5';
