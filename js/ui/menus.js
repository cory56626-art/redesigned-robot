...
import { HOTBAR_SIZE, HEAL_COOLDOWN, MANA_POTION_COOLDOWN, difficultyForIndex, difficultyInfo } from '../config.js?v=worm-surface-4';
import { INV_SIZE, SET_BONUS_DESC, SET_LABEL } from '../systems/inventory.js?v=worm-surface-4';
import { Sprites } from '../art/sprites.js?v=worm-surface-4';
import { item as getItem } from '../data/items.js?v=worm-surface-4';
import { availableRecipes } from '../systems/crafting.js?v=worm-surface-4';
import { claudeNotesHTML } from './claude-notes.js?v=worm-surface-4';
import { LOOK_PALETTES, HAIR_STYLES, defaultAppearance } from '../save.js?v=worm-surface-4';
import { ACHIEVEMENT_BY_ID } from '../systems/achievements.js?v=worm-surface-4';
import { drawCharacterPreview } from '../art/charpreview.js?v=worm-surface-4';
