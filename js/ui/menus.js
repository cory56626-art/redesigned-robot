...
import { HOTBAR_SIZE, HEAL_COOLDOWN, MANA_POTION_COOLDOWN, difficultyForIndex, difficultyInfo } from '../config.js?v=the-worm-1';
import { INV_SIZE, SET_BONUS_DESC, SET_LABEL } from '../systems/inventory.js?v=the-worm-1';
import { Sprites } from '../art/sprites.js?v=the-worm-1';
import { item as getItem } from '../data/items.js?v=the-worm-1';
import { availableRecipes } from '../systems/crafting.js?v=the-worm-1';
import { claudeNotesHTML } from './claude-notes.js?v=the-worm-1';
import { LOOK_PALETTES, HAIR_STYLES, defaultAppearance } from '../save.js?v=the-worm-1';
import { ACHIEVEMENT_BY_ID } from '../systems/achievements.js?v=the-worm-1';
import { drawCharacterPreview } from '../art/charpreview.js?v=the-worm-1';
  ...
  showHowTo() {
    $('howtoBody').innerHTML = `
      ...
      <ul>
        ...
        <li>There are <b>18 realm achievements</b> — see them from the pause menu.</li>
      </ul>
      <h4>Tips</h4>
      <ul>
        ...
        <li>Craft a <b>Crafting Bench</b> and <b>Smeltery</b>, then mine Stoneiron to begin the eight-tier pre-Hardmode ore progression. At a Forge, combine Starsteel Bars, Storm Bars, and Ember Dust into a <b>Mech Beacon</b>; use it on the surface to challenge <b>The Mech</b>. Its Core unlocks a <b>Worm Lure</b> for the Underground.</li>
