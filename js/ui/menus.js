...
import { HOTBAR_SIZE, HEAL_COOLDOWN, MANA_POTION_COOLDOWN, difficultyForIndex, difficultyInfo } from '../config.js?v=prehardmode-weapons-1';
import { INV_SIZE, SET_BONUS_DESC, SET_LABEL } from '../systems/inventory.js?v=prehardmode-weapons-1';
...
import { availableRecipes } from '../systems/crafting.js?v=prehardmode-weapons-1';
import { claudeNotesHTML } from './claude-notes.js?v=prehardmode-weapons-1';
import { LOOK_PALETTES, HAIR_STYLES, defaultAppearance } from '../save.js?v=prehardmode-weapons-1';
import { ACHIEVEMENT_BY_ID } from '../systems/achievements.js?v=prehardmode-weapons-1';
import { drawCharacterPreview } from '../art/charpreview.js?v=prehardmode-weapons-1';
