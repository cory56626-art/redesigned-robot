...
import { LIQUID_MAX, LIQUID_TICK, LIQUID_BUDGET, TILE } from '../config.js?v=prehardmode-ores-1';
import { isSolid } from './tiles.js?v=prehardmode-ores-1';
import { SH, shapeContains } from './shapes.js?v=prehardmode-ores-1';
