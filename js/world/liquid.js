...
import { LIQUID_MAX, LIQUID_TICK, LIQUID_BUDGET, TILE } from '../config.js?v=worm-surface-2';
import { isSolid } from './tiles.js?v=worm-surface-2';
import { SH, shapeContains } from './shapes.js?v=worm-surface-2';
