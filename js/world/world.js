...
import { WORLD_H, TILE, UNDERGROUND_Y, CAVERN_Y } from '../config.js?v=prehardmode-classes-1';
import { T, tileDef, isSolid, tileLight, isLegacyOreTile } from './tiles.js?v=prehardmode-classes-1';
import { W, hasWall, wallBlastResist } from './walls.js?v=prehardmode-classes-1';
import { SH, shapeContains, surfaceOffset, fillsTop } from './shapes.js?v=prehardmode-classes-1';
import { LiquidGrid } from './liquid.js?v=prehardmode-classes-1';
import { BIOME_ORDER } from './biomes.js?v=prehardmode-classes-1';
import { generateWorld } from './worldgen.js?v=prehardmode-classes-1';
