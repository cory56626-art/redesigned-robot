...
import { MSG } from './protocol.js?v=prehardmode-mech-2';
import { NET_SNAPSHOT_HZ, NET_INPUT_HZ, TILE } from '../config.js?v=prehardmode-mech-2';
...
import { ITEMS, isItemEnabled } from '../data/items.js?v=prehardmode-mech-2';
