...
def blue_inferno():
    ...
    for x, y in flame:
        px(img, x, y, edge)
    for x, y in [(7, 4), (8, 4), (9, 4), (7, 5), (8, 5), (9, 5), (10, 5),
                 (6, 6), (7, 6), (8, 6), (9, 6), (10, 6), (7, 7), (8, 7),
                 (9, 7), (10, 7), (7, 8), (8, 8), (9, 8), (10, 8), (8, 9), (9, 9)]:
        px(img, x, y, mid)
    for x, y in [(8, 5), (8, 6), (9, 6), (8, 7), (9, 7), (8, 8)]:
        px(img, x, y, core)
    for x, y in [(7, 11), (8, 11), (9, 11), (7, 12), (8, 12), (9, 12), (6, 10), (10, 10)]:
        px(img, x, y, deep)
    return outline(img)
